...
const TEAMS = [
  ...
  {
    id: "RT-3204",
    name: "Bhairawa Rescue Unit 2",
    location: "Bhairawa, Rupandehi",
    status: "On The Way",
  ...
  {
    id: "RT-5401",
    name: "Palpa Rescue Unit 1",
    location: "Palpa, Tanahun",
    status: "On Mission",
    mission: "Landslide Response",
    members: 5,
    lastUpdate: "9:18 AM",
    lat: 27.9674,
    lng: 82.8309,
  ...
  {
    id: "RT-6601",
    name: "Dang Rescue Unit 1",
    location: "Tulsipur, Dang",
    status: "On The Way",
    mission: "Landslide Rescue",
    members: 4,
    lastUpdate: "09:54 PM",
    lat: 28.1784,
    lng: 82.1752,
  ...
  {
    id: "RT-6604",
    name: "Dharan Rescue Unit 4",
    location: "Dharan, Sunsari",
    status: "On Mission",
    mission: "Crowd Rescue",
    members: 5,
    lastUpdate: "1:14 AM",
    lat: 27.3314,
    lng: 87.6743,
  ...
  {
    id: "RT-5503",
    name: "Sindhupalchok Rescue Unit 3",
  ...
  {
    id: "RT-9910",
    name: "Dolpa Rescue Unit 10",
    location: "Dunai, Dolpa",
    status: "Available",
    mission: "-",
    members: 5,
    lastUpdate: "08:26 AM",
          ...
          {[
            {
              label: "Total Teams",
              value: counts.total,
              sub: "Active across field",
              color: "text-gray-800",
            },
            {
              label: "On Mission",
              value: counts.onMission,
              ...
              {pageRows.map((t) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`text-xs px-2 py-1 rounded-full ${STATUS_STYLE[t.status]}`}
                    >
                      {t.status}
                    </span>
                  </td>
                  <td className="px-4 py-3 text-xs text-gray-600">
                    {t.status === "Available" && t.mission === "-" ? (
                      assignedTeams[t.id] ? (
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                All filtered teams shown · Click a row to locate
              </p>
            </div>
          ...
          <div className="flex items-center gap-2 px-4 py-2 border-b bg-gray-50 text-xs">
            ...
            {selectedTeam && (
              <span className="ml-auto flex items-center gap-1 text-blue-600">
                📍 Focused:{" "}
                <b>{TEAMS.find((t) => t.id === selectedTeam)?.name}</b>
                <button
                  onClick={() => {
                    setSelectedTeam(null);
                    leafletMap.current?.setView([28.0, 83.5], 7);
                  }}
